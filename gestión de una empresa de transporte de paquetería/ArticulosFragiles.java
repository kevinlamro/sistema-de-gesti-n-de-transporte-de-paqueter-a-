import java.io.*;
public class ArticulosFragiles extends Costos {
    ...
    public ArticulosFragiles(float largo, float ancho, float alto, float distancia, String nombre, String tipoEnvio,
    ...
    public void CrearArchivoFragil(){
        registro = new File("C:/Users/User/Documents/factura de envio Fragil.txt");
        try {
           ...
           e.printStackTrace();
            ...
            public void CrearFacturaFragil() throws IOException {
    ...
    //getter
    public File getRegistro() {return registro;}
    public FileWriter getEscribir() {return Escribir;}
    public String getNombre() {return nombre;}
    public String getTipoEnvio() {return tipoEnvio;}
    public String getDireccion() {return direccion;}
    public String getContenido() {return contenido;}
   //setter
    public void setRegistro(File registro) {this.registro = registro;}
    public void setEscribir(FileWriter escribir) {Escribir = escribir;}
